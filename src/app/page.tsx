...
const features = [
    {
        ...
        description:
            'Manage users, monitor transactions, and control token settings—all from a clean, intuitive admin interface. Track performance in real-time and make updates without touching code.'
            ,
...
'TokenPay evolves with your needs—regular updates bring new features, performance enhancements, and security patches to keep everything running smoothly and safely.',        icon: ArrowPathIcon,
    },
    {
        ...
        description:
            'Let users log in or pay using their TokenPay credentials. Whether it’s one-click access or seamless checkout, TokenPay simplifies both identity and transaction flows.',
            ...
            <div className="bg-white pt-24 sm:pt-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <h2 className="text-center text-lg/8 font-semibold text-gray-900">
                        Trusted by the world’s leading online retailers
                    </h2>
                    <div
